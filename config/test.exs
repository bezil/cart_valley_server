...
config :cart_valley_server, CartValleyServerWeb.Endpoint,
  ...
  secret_key_base: "rbXP5Mj4zRpzrA+45qLnkQermUQsenEmdFSqzK33PEna1Ywog6lOInsu6biF1Y80",
  server: false

# In test we don't send emails.
config :cart_valley_server, CartValleyServer.Mailer, adapter: Swoosh.Adapters.Test
